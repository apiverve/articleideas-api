...
// Request contains the parameters for the Article Ideas Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Article Ideas Generator API.
type ResponseData struct {
	Topic string `json:"topic"`
	TopicIdeas int `json:"topicIdeas"`
