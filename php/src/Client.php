...
namespace APIVerve\Articleideas;
...
/**
 * Client for the Article Ideas Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/articleideas?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/articleideas';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ArticleideasClient] {$message}\n";
        }
    }
}
